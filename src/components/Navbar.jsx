        ...
        <div className="flex items-center gap-3">
          ...
          {isAuthenticated ? (
            <button
              ...
              className="hidden md:flex items-center gap-2 px-4 py-2 rounded-xl text-sm border border-white/[0.08] bg-transparent text-[#8a8480] hover:bg-white/5 hover:text-white transition-all duration-200"
            >
              <LogOut size={16} />
              خروج
            </button>
          ...
          <button
            className="md:hidden text-[#8a8480] hover:text-white transition-colors"
        ...
        <div className="md:hidden border-t border-white/[0.06] px-6 py-3 flex flex-col gap-1 bg-dark-bg">
          ...
          {!isAuthenticated ? (
            <Link
              to="/login"
              onClick={() => setMenuOpen(false)}
              className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm no-underline text-[#8a8480] hover:bg-white/5 hover:text-white"
            >
              <LogIn size={16} />
              تسجيل دخول
            </Link>
            ...
            <button
              ...
              className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm text-[#8a8480] hover:bg-white/5 hover:text-white"
            >
              <LogOut size={16} />
              خروج
            </button>
